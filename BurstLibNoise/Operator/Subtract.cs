...
namespace BurstLibNoise.Operator
{
    public class Subtract : LibNoise.Operator.Subtract, BurstModuleBase
    {
        ...
        public static BurstModuleBase ParseData(ModuleData[] moduleData, ref ModuleData data) {
            return new Subtract(StaticMapper.ParseModuleData(moduleData, ref moduleData[data.source1]),
                StaticMapper.ParseModuleData(moduleData, ref moduleData[data.source1]));
        }
