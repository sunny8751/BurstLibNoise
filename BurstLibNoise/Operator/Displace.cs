...
namespace BurstLibNoise.Operator
{
    public class Displace : LibNoise.Operator.Displace, BurstModuleBase
    {
        ...
        public static BurstModuleBase ParseData(ModuleData[] moduleData, ref ModuleData data) {
            return new Displace(StaticMapper.ParseModuleData(moduleData, ref moduleData[data.source1]),
                ...
                StaticMapper.ParseModuleData(moduleData, ref moduleData[data.source4]));
        }
