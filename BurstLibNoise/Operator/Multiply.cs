...
{
    public class Multiply : LibNoise.Operator.Multiply, BurstModuleBase
    {
        public ModuleData GetData(int[] sources) {
            return new ModuleData(ModuleType.Multiply, sources);
        }

        public static BurstModuleBase ParseData(ModuleData[] moduleData, ref ModuleData data) {
            return new Multiply(StaticMapper.ParseModuleData(moduleData, ref moduleData[data.source1]),
