...
namespace BurstLibNoise
{
    internal static class Utils
    {
        ...
        {
            long i = (GeneratorNoiseX * ix + GeneratorNoiseY * iy + GeneratorNoiseZ * iz +
                     GeneratorSeed * seed) & 0xffffffff;
            i ^= (i >> GeneratorShift);
            i &= 0xff;
            var xvg = Randoms[(int) (i << 2)];
            var yvg = Randoms[(int) (i << 2) + 1];
            var zvg = Randoms[(int) (i << 2) + 2];
            var xvp = (fx - ix);
            var yvp = (fy - iy);
            var zvp = (fz - iz);
        ...
        internal static double IEEERemainder(double x, double y) {
